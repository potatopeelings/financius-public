...
public class EventRecurrenceFormatter {
    ...
    public static String getString(Context context, Resources r, long dateStart, EventRecurrence recurrence, boolean includeEndString) {
        String startString = "";
        final String startDateStr = DateUtils.formatDateTime(context, dateStart, DateUtils.FORMAT_ABBREV_MONTH | DateUtils.FORMAT_SHOW_YEAR);
        startString = r.getString(R.string.startFromDate, startDateStr);
        ...
        if (includeEndString) {
            ...
            if (recurrence.until != null) {
                try {
                    ...
                    final String dateStr = DateUtils.formatDateTime(context, time.toMillis(false), DateUtils.FORMAT_ABBREV_MONTH | DateUtils.FORMAT_SHOW_YEAR);
        ...
        switch (recurrence.freq) {
            case EventRecurrence.ONCE:
                return r.getString(R.string.once) + " " + r.getString(R.string.on).toLowerCase() + " " + startDateStr + " " + endString;
            case EventRecurrence.DAILY:
                return r.getQuantityString(R.plurals.daily, interval, interval) + " " + startString + " " + endString;
            case EventRecurrence.WEEKLY: {
                if (recurrence.repeatsOnEveryWeekDay()) {
                    return r.getString(R.string.every_weekday) + " " + startString + " " + endString;
                } else {
                    String string;
                    ...
                    return r.getQuantityString(R.plurals.weekly, interval, interval, string) + " " + startString + " " + endString;
                }
            }
            case EventRecurrence.MONTHLY: {
                ...
                return r.getQuantityString(R.plurals.monthly, interval, interval, details).trim() + " " + startString + " " + endString;
            }
            case EventRecurrence.YEARLY:
                return r.getQuantityString(R.plurals.yearly_plain, interval, interval, "") + " " + startString + " " + endString;
        }
