...
public class TransactionFilterActivity extends BaseActivity {
    ...
    public static void start(Context context) {
        final Intent intent = makeIntentForActivity(context, TransactionFilterActivity.class);
    ...
    @Override protected ActivityPresenter onCreateActivityPresenter() {
        return new TransactionFilterActivityPresenter(getEventBus(), currenciesManager, amountFormatter, transactionFilter);
    }

    @Override protected Analytics.Screen getScreen() {
        return Analytics.Screen.TransactionFilter;
    }
}
