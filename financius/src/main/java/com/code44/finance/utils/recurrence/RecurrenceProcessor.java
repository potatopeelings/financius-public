package com.code44.finance.utils.recurrence;
...
public class RecurrenceProcessor
{
    ...
    public void expand(Time dtstart,
        ...
        Time rangeStartTime = new Time();
        rangeStartTime.set(rangeStartDateValue);
        rangeStartDateValue = normDateTimeComparisonValue(rangeStartTime);
        Time rangeEndTime = new Time();
        rangeEndTime.set(rangeEndDateValue);
        rangeEndDateValue = normDateTimeComparisonValue(rangeEndTime);
        int count = 0;
